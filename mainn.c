...
void mostra_texto()
{
    ...
    ALLEGRO_BITMAP *fundo =
        al_load_bitmap("utils/scroll.jpg");
    ALLEGRO_BITMAP *sprites[3];
    sprites[0] = al_load_bitmap("utils/frame01.png");
    al_convert_mask_to_alpha(sprites[0], al_map_rgb(0xFF, 0, 0xFF));
    sprites[1] = al_load_bitmap("utils/frame02.png");
    al_convert_mask_to_alpha(sprites[1], al_map_rgb(0xFF, 0, 0xFF));
    sprites[2] = al_load_bitmap("utils/frame03.png");
...
{
    ALLEGRO_BITMAP *fundo =
        al_load_bitmap("utils/flappy_bg.jpg");
...
int main()
{
    ...
    // Música, Mario MC Melo Kikando e Me Olhando!
